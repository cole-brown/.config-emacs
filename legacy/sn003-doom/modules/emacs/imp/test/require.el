...
(ert-deftest test<imp/require>::int<imp>:load ()
  "Test that `int<imp>:load' behaves appropriately."
  (test<imp>:fixture
      ;;===
      ;; Test name, setup & teardown func.
      ;;===
      "test<imp/require>::int<imp>:load"
      nil
      nil
    ...
    ;; Call `int<imp>:load on it's feature; shouldn't be loaded since we've required it already.
