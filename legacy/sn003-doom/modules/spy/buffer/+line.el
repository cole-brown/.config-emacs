...
(defun spy/smarter-move-beginning-of-line (arg)
...
(defun spy/smarter-beginning-of-visual-line (arg)
...
"
  ...
  (let ((orig-point (point)))
    ...
    ;; If that did nothing, jump into `spy/smarter-move-beginning-of-line'
    ;; for more beginnings.
    (when (= orig-point (point))
      (spy/smarter-move-beginning-of-line 1))))


(defun spy/smarter-end-of-visual-line (arg)
