;;; mantle/config/dev-env/web.el --- `web-mode' and friends (HTML stuff) -*- lexical-binding: t; -*-
;;
...
;;; Commentary:
;;
;; `web-mode' and friends. HTML stuff.
;;
;;; Code:
...
;; The End.
;;------------------------------------------------------------------------------
(imp:provide :mantle 'config 'dev-env 'languages 'web)
